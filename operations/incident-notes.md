...
> Full mechanics: [VM Disk, Discard, and TRIM](../core-infrastructure/vm-disk-and-trim). Step-by-step recovery: [Proxmox Storage Runbook](../core-infrastructure/proxmox-storage-runbook).
